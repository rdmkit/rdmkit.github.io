...
},{}],"../../node_modules/compute-scroll-into-view/es/index.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"compute-scroll-into-view":"../../node_modules/compute-scroll-into-view/es/index.js"}],"../../node_modules/smooth-scroll-into-view-if-needed/es/index.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"scroll-into-view-if-needed":"../../node_modules/scroll-into-view-if-needed/es/index.js"}],"../../node_modules/prismjs/prism.js":[function(require,module,exports) {
...
function toggleMargins() {
  ...
  setTimeout(function () {
    ...
    (0, _smoothScrollIntoViewIfNeeded.default)(desktopBtn, {
      behavior: "smooth",
      block: "center"
    });
  }, 500);
...
fixSpaceBtn.addEventListener("click", toggleFixSpace); // const btns = document.querySelectorAll("button");

function toggleFixSpace() {
  toggleActivated(fixSpaceBtn);
  root.classList.toggle("fix-space"); // for (let b of btns) {
  //   b.classList.toggle("noBorders");
  // }

  setTimeout(function () {
    fixSpaceBtn.classList.add("animate-flicker");
    (0, _smoothScrollIntoViewIfNeeded.default)(fixSpaceBtn, {
      behavior: "smooth",
      block: "center"
    });
  }, 500);
